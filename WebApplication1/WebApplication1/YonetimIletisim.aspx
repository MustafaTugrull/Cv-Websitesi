<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="YonetimIletisim.aspx.cs" Inherits="WebApplication1.WebForm5" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:webprojesiConnectionString %>" SelectCommand="SELECT * FROM [METIN] WHERE ICERIK = 'ILETISIM'"></asp:SqlDataSource>
</asp:Content>