<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="İletişim.aspx.cs" Inherits="WebApplication1.İletişim" %>
    ...
    <form id="form1" runat="server">
        ...
        <section class="contact-section">
            <div class="container">
                        ...
                        <div style="height: 100%; width: 100%; position: absolute; top: 0px; left: 0px; background-color: rgb(229, 227, 223);">
                            <div class="gm-style" style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px;">
                                ...
                                <div style="margin-left: 5px; margin-right: 5px; z-index: 1000000; position: absolute; left: 0px; bottom: 0px;">
                                    <a target="_blank" rel="noopener" href=https://goo.gl/maps/PkWc8etKjn9eusgE7 title="Open this area in Google Maps (opens a new window)" style="position: static; overflow: visible; float: none; display: inline;">
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Yardıma mı ihtiyacın var?</h2>
                    </div>
                    <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <asp:TextBox ID="message1" class="form-control w-100" runat="server" Columns="30" Rows="9" placeholder=" Mesaj *" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <asp:TextBox ID="name" class="form-control valid" runat="server" placeholder="İsim *"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <asp:TextBox ID="email" class="form-control valid" runat="server" placeholder="E-Posta Adresi *"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <asp:TextBox ID="subject" class="form-control" runat="server" placeholder="Konu"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mt-3">
                                <asp:Button ID="Button1" OnClick="Button1_Click" runat="server" Text="Gönder" class="button button-contactForm boxed-btn" />
