<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="YonetimAnasayfa.aspx.cs" Inherits="WebApplication1.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:webprojesiConnectionString %>" SelectCommand="SELECT * FROM [METIN] WHERE ICERIK = 'ANASAYFA'"></asp:SqlDataSource>
</asp:Content>
