<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="YonetimFooter.aspx.cs" Inherits="WebApplication1.WebForm6" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:webprojesiConnectionString %>" SelectCommand="SELECT * FROM [METIN] WHERE ICERIK = 'FOOTER'"></asp:SqlDataSource>
</asp:Content>