<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hakkında.aspx.cs" Inherits="WebApplication1.Hakkında" %>
    ...
    <form id="form1" runat="server">
        ...
        <main>
            ...
            <div class="slider-area ">
                <!-- Mobile Menu -->
                <div class="single-slider slider-height2 d-flex align-items-center" data-background="assets/img/hero/gallery2.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="hero-cap">
