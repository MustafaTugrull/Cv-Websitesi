<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="YonetimBiyografi.aspx.cs" Inherits="WebApplication1.WebForm2" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:webprojesiConnectionString %>" SelectCommand="SELECT * FROM [METIN] WHERE ICERIK = 'BIYOGRAFI'"></asp:SqlDataSource>
</asp:Content>
